...
# Removed Ascent Stage Parameters
...
# Removed Target Orbit Parameters

# Simulation time parameters
t_max_descent = 800 # s, max descent sim time
# Removed surface stay, ascent, and rendezvous times
...
def descent_derivatives(t, state):
    ...
    v_dot = a_thrust * np.sin(abs(gamma_rad)) + a_gravity * np.sin(gamma_rad)
...
# Removed Ascent Stage Guidance functions
# Removed Ascent Trajectory Simulation function
# Removed reach_target_altitude event function
...
descent_initial_state = [
    ...
    launch_longitude + 3.175,   # Initial longitude (farther to the right for starting more on the x+ axis)
...
# Removed ascent simulation call and results processing

# Calculate actual mission timestamps
surface_start_time = landing_time
# Removed ascent_start_time and ascent_end_time
...
# Removed ascent trajectory cartesian conversion
...
# Removed LM Ascent trajectory CZML block
